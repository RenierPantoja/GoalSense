...
13. E10 (future) — Re-validate workers on a live rich match, backup/export, deploy indexes, flip the deploy-env default, approved data migration, then remove Prisma.
