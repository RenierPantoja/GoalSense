...
import { ToggleSettingRow } from './components/pattern-studio/shell/ToggleSettingRow'
import { EntityAvatar } from './components/pattern-studio/scope/EntityAvatar'
import { LeaguePicker } from './components/pattern-studio/scope/LeaguePicker'
import { TeamPicker } from './components/pattern-studio/scope/TeamPicker'
import { MatchPicker } from './components/pattern-studio/scope/MatchPicker'
import { ScopePicker } from './components/pattern-studio/scope/ScopePicker'
import { ConditionsEditor } from './components/pattern-studio/triggers/ConditionsEditor'
import { SeverityPicker } from './components/pattern-studio/form-controls/SeverityPicker'
import { ActionCardPicker } from './components/pattern-studio/form-controls/ActionCardPicker'
import { ConfidenceSlider } from './components/pattern-studio/form-controls/ConfidenceSlider'
import { RadarInspectorPanel } from './components/pattern-studio/inspector/RadarInspectorPanel'
import { RadarPreview } from './components/pattern-studio/preview/RadarPreview'
...
// ConditionsEditor moved to components/pattern-studio/triggers/ConditionsEditor
// ParamField moved to components/pattern-studio/triggers/ParamField

// SeverityPicker moved to components/pattern-studio/form-controls/SeverityPicker

// ═══ TOGGLE SETTING ROW — moved to components/pattern-studio/shell/ToggleSettingRow
...
// RadarInspectorPanel + InspectorRow + InspectorBadge + ExclusionAvatarRow
// moved to components/pattern-studio/inspector/*

// ActionCardPicker moved to components/pattern-studio/form-controls/ActionCardPicker
...
// EntityAvatar moved to components/pattern-studio/scope/EntityAvatar
...
// LeaguePicker / TeamPicker / MatchPicker / ScopePicker / EntityAvatar /
// ScopeMode / SCOPE_PALETTE moved to components/pattern-studio/scope/*

// ConfidenceSlider moved to components/pattern-studio/form-controls/ConfidenceSlider
...
// RadarPreview moved to components/pattern-studio/preview/RadarPreview
